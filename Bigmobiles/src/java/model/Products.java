 ...
 */
@Entity
@Table(name = "Products", catalog = "bigmobiles", schema = "dbo")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Products.findByDes2", query = "SELECT p FROM Products p WHERE p.des2 = :des2"),
...
public class Products implements Serializable {
    ...
    public Products(String productID, String productName, String image1, String image2, String image3, String image4, double price, String description, String des2, Date createdDate, String feature, Boolean productState, Brand brandID, Category categoryID, Collection<OrderDetails> orderDetailsCollection, Collection<Wishlist> wishlistCollection, Collection<Rating> ratingCollection) {
        this.productID = productID;
        this.productName = productName;
        this.image1 = image1;
        this.image2 = image2;
